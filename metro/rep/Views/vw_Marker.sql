    ...
    */
    SELECT 
        ...
        LTRIM(RTRIM(CAST([MarkerVersion] AS varchar(255)))) AS [MarkerVersion],
        LTRIM(RTRIM(CAST([IsSystem] AS varchar(255)))) AS [IsSystem],
        LTRIM(RTRIM(CAST([Pre] AS varchar(255)))) AS [Pre],
        LTRIM(RTRIM(CAST([Post] AS varchar(255)))) AS [Post],
        ...
        mta_RH         = CONVERT(
            ...
            HASHBYTES(
                ...
                UPPER(
                    ...
                    + '|'
                    + ISNULL(LTRIM(RTRIM(CAST([MarkerVersion] AS VARCHAR(255)))),'-')
                    + '|'
                    + ISNULL(LTRIM(RTRIM(CAST([IsSystem] AS VARCHAR(255)))),'-')
                    + '|'
                    + ISNULL(LTRIM(RTRIM(CAST([Pre] AS VARCHAR(255)))),'-')
                    + '|'
                    + ISNULL(LTRIM(RTRIM(CAST([Post] AS VARCHAR(255)))),'-')
                    + '|'
