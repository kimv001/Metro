...
SELECT -- List of columns:
 ...
 mta_rownum = row_number() OVER (
       ...
       mta_rh = convert(char(64), hashbytes('SHA2_512', upper(isnull(ltrim(rtrim(cast([bk] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([code] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([name] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([description] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([active] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([bk_schema] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([stotype] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([prefix] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([bk_datasettrn_based_on] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([kolom1] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([bk_schedule] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([bk_schema_to] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([container] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([folder] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([filename] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([datetime] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([bk_fileformat] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([where_filter] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([order_by] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([bk_contactgroup] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([split_by] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([bk_reftype_repositorystatus] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([mta_source] AS varchar(255)))), '-') + '|' + isnull(ltrim(rtrim(cast([mta_loaddate] AS varchar(255)))), '-'))), 2)
