        ...
        mta_RH         = CONVERT(
            ...
            HASHBYTES(
                ...
                UPPER(
                    ...
                    + '|'
                    + ISNULL(LTRIM(RTRIM(CAST([LinkedServicePropertiesName] AS VARCHAR(255)))),'-')
                    + '|'
                    + ISNULL(LTRIM(RTRIM(CAST([LinkedServicePropertiesValue] AS VARCHAR(255)))),'-')
                    + '|'
                    + ISNULL(LTRIM(RTRIM(CAST([LinkedServicePropertiesDesc] AS VARCHAR(8000)))),'-')
                    + '|'
