	...
	exec [bld].[load_510_Markers_040_DatasetColumnlistsByCode]*/

	
	DECLARE @RoutineName	varchar(8000)	= 'load_510_Markers_040_DatasetColumnlistsByCode'
	...
	INTO #510_Markers_040_DatasetColumnlistsByCode
	...
	CREATE CLUSTERED INDEX [IX_tr_510_Markers_040_DatasetColumnlistsByCode] ON #510_Markers_040_DatasetColumnlistsByCode( [mta_BKH] ASC,[mta_RH] ASC)
	...
	FROM  [bld].[tr_510_Markers_040_DatasetColumnlistsByCode] src
	JOIN #510_Markers_040_DatasetColumnlistsByCode h ON h.[mta_BK] = src.[BK]
	...
	LEFT JOIN #510_Markers_040_DatasetColumnlistsByCode h ON h.[mta_BKH] = src.[mta_BKH] AND h.[mta_Source] = src.[mta_Source]
	WHERE 1=1 AND h.[mta_BKH] IS null AND  src.mta_Source = '[bld].[tr_510_Markers_040_DatasetColumnlistsByCode]'
	AND  h.mta_RecType =-1
...
DROP TABLE #510_Markers_040_DatasetColumnlistsByCode;
	...
	PRINT 'Load "load_510_Markers_040_DatasetColumnlistsByCode" took ' +CAST(@Duration AS varchar(10))+ ' second(s)'