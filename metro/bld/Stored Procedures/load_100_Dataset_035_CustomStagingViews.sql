	...
	create proc [bld].[load_100_Dataset_035_CustomStagingViews] as
	/*
	Proc is generated by	: metro
	Generated at			: 2025-01-06 14:43:27
	
	exec [bld].[load_100_Dataset_035_CustomStagingViews]*/

	
	Declare @RoutineName	varchar(8000)	= 'load_100_Dataset_035_CustomStagingViews'
	...
	If OBJECT_ID('tempdb..#100_Dataset_035_CustomStagingViews') IS NOT NULL 
	Drop Table #100_Dataset_035_CustomStagingViews ;
	...
	, mta_Source	= '[bld].[tr_100_Dataset_035_CustomStagingViews]'
	, mta_RecType	= case 
	...
	Into #100_Dataset_035_CustomStagingViews
	From [bld].[tr_100_Dataset_035_CustomStagingViews] src
	Left join [bld].[vw_Dataset] tgt on src.[BK] = tgt.[BK]
	
	
	
	Create Clustered INDEX [IX_tr_100_Dataset_035_CustomStagingViews] ON #100_Dataset_035_CustomStagingViews( [mta_BKH] ASC,[mta_RH] ASC)
	...
	Left Join #100_Dataset_035_CustomStagingViews h on h.[mta_BKH] = src.[mta_BKH] and h.[mta_Source] = src.[mta_Source]
	Where 1=1 and h.[mta_BKH] is null and  src.mta_Source = '[bld].[tr_100_Dataset_035_CustomStagingViews]'
...
Drop Table #100_Dataset_035_CustomStagingViews;
	...
	print 'Load "load_100_Dataset_035_CustomStagingViews" took ' +cast(@Duration as varchar(10))+ ' second(s)'