...
CREATE proc [bld].[load_010_reftype_010_default] AS /*
	...
	exec [bld].[load_010_RefType_010_Default]*/  DECLARE @routinename varchar(8000) = 'load_010_RefType_010_Default' DECLARE @startdatetime datetime2 = getutcdate() DECLARE @enddatetime datetime2 DECLARE @duration bigint -- Create a helper temp table
 IF object_id('tempdb..#010_RefType_010_Default') IS NOT NULL
DROP TABLE # 010_reftype_010_default ; PRINT '-- create temp table:'
SELECT mta_bk = src.[bk] ,
       ...
       mta_rectype = CASE
            ...
            ELSE -99
             ...
             END INTO # 010_reftype_010_default

  FROM [bld].[tr_010_reftype_010_default] src

  LEFT JOIN [bld].[vw_reftype] tgt
    ON src.[bk] = tgt.[bk]
CREATE clustered INDEX [ix_tr_010_reftype_010_default]
    ON # 010_reftype_010_default([mta_bkh] ASC, [mta_rh] ASC) --------------------- start loading data
 PRINT '-- new records:'

   SET @startdatetime = getdate()
INSERT INTO [bld].[reftype] ([bk], [code], [name], [description], [reftype], [reftypeabbr], [sortorder], [linkedreftype], [bk_linkedreftype], [linkedreftypecode], [linkedreftypename], [linkedreftypedecription], [defaultvalue], [isdefault] , [mta_bk], [mta_bkh], [mta_rh], [mta_source], [mta_rectype])
SELECT src.[bk],
  ...
  JOIN # 010_reftype_010_default h
    ON h.[mta_bk] = src.[bk]
...
SELECT src.[bk],
  ...
  LEFT JOIN # 010_reftype_010_default h
 ...
 WHERE 1 = 1
   ...
   AND src.mta_source = '[bld].[tr_010_RefType_010_Default]'
 ...
 IF object_id('tempdb..#010_RefType_010_Default') IS NOT NULL
  DROP TABLE # 010_reftype_010_default;
   ...
   SET @duration = datediff(ss, @startdatetime, @enddatetime) PRINT 'Load "load_010_RefType_010_Default" took ' + cast(@duration AS varchar(10)) + ' second(s)'
