...
CREATE proc [bld].[load_100_dataset_040_aliasviews] AS /*
	...
	exec [bld].[load_100_Dataset_040_AliasViews]*/  DECLARE @routinename varchar(8000) = 'load_100_Dataset_040_AliasViews' DECLARE @startdatetime datetime2 = getutcdate() DECLARE @enddatetime datetime2 DECLARE @duration bigint -- Create a helper temp table
 IF object_id('tempdb..#100_Dataset_040_AliasViews') IS NOT NULL
DROP TABLE # 100_dataset_040_aliasviews ; PRINT '-- create temp table:'
...
SELECT src.[bk],
  ...
  JOIN # 100_dataset_040_aliasviews h
    ON h.[mta_bk] = src.[bk]
...
SELECT src.[bk],
  ...
  LEFT JOIN # 100_dataset_040_aliasviews h
 ...
 WHERE 1 = 1
   ...
   AND src.mta_source = '[bld].[tr_100_Dataset_040_AliasViews]'
 ...
 IF object_id('tempdb..#100_Dataset_040_AliasViews') IS NOT NULL
  DROP TABLE # 100_dataset_040_aliasviews;
   ...
   SET @duration = datediff(ss, @startdatetime, @enddatetime) PRINT 'Load "load_100_Dataset_040_AliasViews" took ' + cast(@duration AS varchar(10)) + ' second(s)'
