	...
	exec [bld].[load_510_Markers_025_DatasetSRCFileProperties]*/

	
	DECLARE @RoutineName	varchar(8000)	= 'load_510_Markers_025_DatasetSRCFileProperties'
	...
	INTO #510_Markers_025_DatasetSRCFileProperties
	...
	CREATE CLUSTERED INDEX [IX_tr_510_Markers_025_DatasetSRCFileProperties] ON #510_Markers_025_DatasetSRCFileProperties( [mta_BKH] ASC,[mta_RH] ASC)
	...
	FROM  [bld].[tr_510_Markers_025_DatasetSRCFileProperties] src
	JOIN #510_Markers_025_DatasetSRCFileProperties h ON h.[mta_BK] = src.[BK]
	...
	LEFT JOIN #510_Markers_025_DatasetSRCFileProperties h ON h.[mta_BKH] = src.[mta_BKH] AND h.[mta_Source] = src.[mta_Source]
	WHERE 1=1 AND h.[mta_BKH] IS null AND  src.mta_Source = '[bld].[tr_510_Markers_025_DatasetSRCFileProperties]'
	AND  h.mta_RecType =-1
...
DROP TABLE #510_Markers_025_DatasetSRCFileProperties;
	...
	PRINT 'Load "load_510_Markers_025_DatasetSRCFileProperties" took ' +CAST(@Duration AS varchar(10))+ ' second(s)'