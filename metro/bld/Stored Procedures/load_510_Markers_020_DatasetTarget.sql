...
CREATE proc [bld].[load_510_markers_020_datasettarget] AS /*
	...
	exec [bld].[load_510_Markers_020_DatasetTarget]*/  DECLARE @routinename varchar(8000) = 'load_510_Markers_020_DatasetTarget' DECLARE @startdatetime datetime2 = getutcdate() DECLARE @enddatetime datetime2 DECLARE @duration bigint -- Create a helper temp table
 IF object_id('tempdb..#510_Markers_020_DatasetTarget') IS NOT NULL
DROP TABLE # 510_markers_020_datasettarget ; PRINT '-- create temp table:'
SELECT mta_bk = src.[bk] ,
       ...
       mta_rectype = diff.rectype INTO # 510_markers_020_datasettarget
 ...
 WHERE 1 = 1
  ...
  CREATE clustered INDEX [ix_tr_510_markers_020_datasettarget]
    ON # 510_markers_020_datasettarget([mta_bkh] ASC, [mta_rh] ASC) --------------------- start loading data
 PRINT '-- new records:'
...
SELECT src.[bk],
  ...
  JOIN # 510_markers_020_datasettarget h
    ON h.[mta_bk] = src.[bk]
...
SELECT src.[bk],
  ...
  LEFT JOIN # 510_markers_020_datasettarget h
 ...
 WHERE 1 = 1
   ...
   AND src.mta_source = '[bld].[tr_510_Markers_020_DatasetTarget]'
 ...
 IF object_id('tempdb..#510_Markers_020_DatasetTarget') IS NOT NULL
  DROP TABLE # 510_markers_020_datasettarget;
   ...
   SET @duration = datediff(ss, @startdatetime, @enddatetime) PRINT 'Load "load_510_Markers_020_DatasetTarget" took ' + cast(@duration AS varchar(10)) + ' second(s)'
