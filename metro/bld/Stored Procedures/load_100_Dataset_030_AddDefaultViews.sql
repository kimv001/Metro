...
CREATE proc [bld].[load_100_dataset_030_adddefaultviews] AS /*
	...
	exec [bld].[load_100_Dataset_030_AddDefaultViews]*/  DECLARE @routinename varchar(8000) = 'load_100_Dataset_030_AddDefaultViews' DECLARE @startdatetime datetime2 = getutcdate() DECLARE @enddatetime datetime2 DECLARE @duration bigint -- Create a helper temp table
 IF object_id('tempdb..#100_Dataset_030_AddDefaultViews') IS NOT NULL
DROP TABLE # 100_dataset_030_adddefaultviews ; PRINT '-- create temp table:'
SELECT mta_bk = src.[bk] ,
       ...
       mta_rectype = CASE
            ...
            ELSE -99
             ...
             END INTO # 100_dataset_030_adddefaultviews

  FROM [bld].[tr_100_dataset_030_adddefaultviews] src

  LEFT JOIN [bld].[vw_dataset] tgt
    ON src.[bk] = tgt.[bk]
CREATE clustered INDEX [ix_tr_100_dataset_030_adddefaultviews]
    ON # 100_dataset_030_adddefaultviews([mta_bkh] ASC, [mta_rh] ASC) --------------------- start loading data
 PRINT '-- new records:'
...
SELECT src.[bk],
  ...
  JOIN # 100_dataset_030_adddefaultviews h
    ON h.[mta_bk] = src.[bk]
...
SELECT src.[bk],
  ...
  LEFT JOIN # 100_dataset_030_adddefaultviews h
 ...
 WHERE 1 = 1
   ...
   AND src.mta_source = '[bld].[tr_100_Dataset_030_AddDefaultViews]'
 ...
 IF object_id('tempdb..#100_Dataset_030_AddDefaultViews') IS NOT NULL
  DROP TABLE # 100_dataset_030_adddefaultviews;
   ...
   SET @duration = datediff(ss, @startdatetime, @enddatetime) PRINT 'Load "load_100_Dataset_030_AddDefaultViews" took ' + cast(@duration AS varchar(10)) + ' second(s)'
