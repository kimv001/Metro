...
CREATE proc [bld].[load_100_dataset_021_datasettrnflowdatasets] AS /*
	...
	exec [bld].[load_100_Dataset_021_DatasetTrnFlowDatasets]*/  DECLARE @routinename varchar(8000) = 'load_100_Dataset_021_DatasetTrnFlowDatasets' DECLARE @startdatetime datetime2 = getutcdate() DECLARE @enddatetime datetime2 DECLARE @duration bigint -- Create a helper temp table
 IF object_id('tempdb..#100_Dataset_021_DatasetTrnFlowDatasets') IS NOT NULL
DROP TABLE # 100_dataset_021_datasettrnflowdatasets ; PRINT '-- create temp table:'
SELECT mta_bk = src.[bk] ,
       ...
       mta_rectype = CASE
            ...
            ELSE -99
             ...
             END INTO # 100_dataset_021_datasettrnflowdatasets

  FROM [bld].[tr_100_dataset_021_datasettrnflowdatasets] src

  LEFT JOIN [bld].[vw_dataset] tgt
    ON src.[bk] = tgt.[bk]
CREATE clustered INDEX [ix_tr_100_dataset_021_datasettrnflowdatasets]
    ON # 100_dataset_021_datasettrnflowdatasets([mta_bkh] ASC, [mta_rh] ASC) --------------------- start loading data
 PRINT '-- new records:'
...
SELECT src.[bk],
  ...
  JOIN # 100_dataset_021_datasettrnflowdatasets h
    ON h.[mta_bk] = src.[bk]
...
SELECT src.[bk],
  ...
  LEFT JOIN # 100_dataset_021_datasettrnflowdatasets h
 ...
 WHERE 1 = 1
   ...
   AND src.mta_source = '[bld].[tr_100_Dataset_021_DatasetTrnFlowDatasets]'
 ...
 IF object_id('tempdb..#100_Dataset_021_DatasetTrnFlowDatasets') IS NOT NULL
  DROP TABLE # 100_dataset_021_datasettrnflowdatasets;
   ...
   SET @duration = datediff(ss, @startdatetime, @enddatetime) PRINT 'Load "load_100_Dataset_021_DatasetTrnFlowDatasets" took ' + cast(@duration AS varchar(10)) + ' second(s)'
