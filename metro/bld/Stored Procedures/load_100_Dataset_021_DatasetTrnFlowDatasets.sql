	...
	create proc [bld].[load_100_Dataset_021_DatasetTrnFlowDatasets] as
	/*
	Proc is generated by	: metro
	Generated at			: 2025-01-06 14:43:27
	
	exec [bld].[load_100_Dataset_021_DatasetTrnFlowDatasets]*/

	
	Declare @RoutineName	varchar(8000)	= 'load_100_Dataset_021_DatasetTrnFlowDatasets'
	...
	If OBJECT_ID('tempdb..#100_Dataset_021_DatasetTrnFlowDatasets') IS NOT NULL 
	Drop Table #100_Dataset_021_DatasetTrnFlowDatasets ;
	...
	, mta_Source	= '[bld].[tr_100_Dataset_021_DatasetTrnFlowDatasets]'
	, mta_RecType	= case 
	...
	Into #100_Dataset_021_DatasetTrnFlowDatasets
	From [bld].[tr_100_Dataset_021_DatasetTrnFlowDatasets] src
	Left join [bld].[vw_Dataset] tgt on src.[BK] = tgt.[BK]
	
	
	
	Create Clustered INDEX [IX_tr_100_Dataset_021_DatasetTrnFlowDatasets] ON #100_Dataset_021_DatasetTrnFlowDatasets( [mta_BKH] ASC,[mta_RH] ASC)
	...
	Left Join #100_Dataset_021_DatasetTrnFlowDatasets h on h.[mta_BKH] = src.[mta_BKH] and h.[mta_Source] = src.[mta_Source]
	Where 1=1 and h.[mta_BKH] is null and  src.mta_Source = '[bld].[tr_100_Dataset_021_DatasetTrnFlowDatasets]'
...
Drop Table #100_Dataset_021_DatasetTrnFlowDatasets;
	...
	print 'Load "load_100_Dataset_021_DatasetTrnFlowDatasets" took ' +cast(@Duration as varchar(10))+ ' second(s)'