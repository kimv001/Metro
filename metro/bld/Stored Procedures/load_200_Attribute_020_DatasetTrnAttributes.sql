...
CREATE proc [bld].[load_200_attribute_020_datasettrnattributes] AS /*
	...
	exec [bld].[load_200_Attribute_020_DatasetTrnAttributes]*/  DECLARE @routinename varchar(8000) = 'load_200_Attribute_020_DatasetTrnAttributes' DECLARE @startdatetime datetime2 = getutcdate() DECLARE @enddatetime datetime2 DECLARE @duration bigint -- Create a helper temp table
 IF object_id('tempdb..#200_Attribute_020_DatasetTrnAttributes') IS NOT NULL
DROP TABLE # 200_attribute_020_datasettrnattributes ; PRINT '-- create temp table:'
SELECT mta_bk = src.[bk] ,
       ...
       mta_rectype = CASE
            ...
            ELSE -99
             ...
             END INTO # 200_attribute_020_datasettrnattributes

  FROM [bld].[tr_200_attribute_020_datasettrnattributes] src

  LEFT JOIN [bld].[vw_attribute] tgt
    ON src.[bk] = tgt.[bk]
CREATE clustered INDEX [ix_tr_200_attribute_020_datasettrnattributes]
    ON # 200_attribute_020_datasettrnattributes([mta_bkh] ASC, [mta_rh] ASC) --------------------- start loading data
 PRINT '-- new records:'
...
SELECT src.[bk],
  ...
  JOIN # 200_attribute_020_datasettrnattributes h
    ON h.[mta_bk] = src.[bk]
...
SELECT src.[bk],
  ...
  LEFT JOIN # 200_attribute_020_datasettrnattributes h
 ...
 WHERE 1 = 1
   ...
   AND src.mta_source = '[bld].[tr_200_Attribute_020_DatasetTrnAttributes]'
 ...
 IF object_id('tempdb..#200_Attribute_020_DatasetTrnAttributes') IS NOT NULL
  DROP TABLE # 200_attribute_020_datasettrnattributes;
   ...
   SET @duration = datediff(ss, @startdatetime, @enddatetime) PRINT 'Load "load_200_Attribute_020_DatasetTrnAttributes" took ' + cast(@duration AS varchar(10)) + ' second(s)'
