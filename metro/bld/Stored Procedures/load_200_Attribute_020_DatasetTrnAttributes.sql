	...
	create proc [bld].[load_200_Attribute_020_DatasetTrnAttributes] as
	/*
	Proc is generated by	: metro
	Generated at			: 2025-01-06 14:43:27
	
	exec [bld].[load_200_Attribute_020_DatasetTrnAttributes]*/

	
	Declare @RoutineName	varchar(8000)	= 'load_200_Attribute_020_DatasetTrnAttributes'
	...
	If OBJECT_ID('tempdb..#200_Attribute_020_DatasetTrnAttributes') IS NOT NULL 
	Drop Table #200_Attribute_020_DatasetTrnAttributes ;
	...
	, mta_Source	= '[bld].[tr_200_Attribute_020_DatasetTrnAttributes]'
	, mta_RecType	= case 
	...
	Into #200_Attribute_020_DatasetTrnAttributes
	From [bld].[tr_200_Attribute_020_DatasetTrnAttributes] src
	Left join [bld].[vw_Attribute] tgt on src.[BK] = tgt.[BK]
	
	
	
	Create Clustered INDEX [IX_tr_200_Attribute_020_DatasetTrnAttributes] ON #200_Attribute_020_DatasetTrnAttributes( [mta_BKH] ASC,[mta_RH] ASC)
	...
	From  [bld].[tr_200_Attribute_020_DatasetTrnAttributes] src
	Join #200_Attribute_020_DatasetTrnAttributes h on h.[mta_BK] = src.[BK]
	...
	Left Join #200_Attribute_020_DatasetTrnAttributes h on h.[mta_BKH] = src.[mta_BKH] and h.[mta_Source] = src.[mta_Source]
	Where 1=1 and h.[mta_BKH] is null and  src.mta_Source = '[bld].[tr_200_Attribute_020_DatasetTrnAttributes]'
...
Drop Table #200_Attribute_020_DatasetTrnAttributes;
	...
	print 'Load "load_200_Attribute_020_DatasetTrnAttributes" took ' +cast(@Duration as varchar(10))+ ' second(s)'