...
CREATE proc [bld].[load_650_datasettemplates_010_default] AS /*
	...
	exec [bld].[load_650_DatasetTemplates_010_default]*/  DECLARE @routinename varchar(8000) = 'load_650_DatasetTemplates_010_default' DECLARE @startdatetime datetime2 = getutcdate() DECLARE @enddatetime datetime2 DECLARE @duration bigint -- Create a helper temp table
 IF object_id('tempdb..#650_DatasetTemplates_010_default') IS NOT NULL
DROP TABLE # 650_datasettemplates_010_default ; PRINT '-- create temp table:'
SELECT mta_bk = src.[bk] ,
       ...
       mta_rectype = CASE
            ...
            ELSE -99
             ...
             END INTO # 650_datasettemplates_010_default

  FROM [bld].[tr_650_datasettemplates_010_default] src

  LEFT JOIN [bld].[vw_datasettemplates] tgt
    ON src.[bk] = tgt.[bk]
CREATE clustered INDEX [ix_tr_650_datasettemplates_010_default]
    ON # 650_datasettemplates_010_default([mta_bkh] ASC, [mta_rh] ASC) --------------------- start loading data
 PRINT '-- new records:'

   SET @startdatetime = getdate()
INSERT INTO [bld].[datasettemplates] ([bk], [code], [bk_template], [bk_dataset], [templatetype], [templatesource], [bk_reftype_objecttype], [templatescript], [rownum] , [mta_bk], [mta_bkh], [mta_rh], [mta_source], [mta_rectype])
SELECT src.[bk],
  ...
  JOIN # 650_datasettemplates_010_default h
    ON h.[mta_bk] = src.[bk]
...
SELECT src.[bk],
  ...
  LEFT JOIN # 650_datasettemplates_010_default h
 ...
 WHERE 1 = 1
   ...
   AND src.mta_source = '[bld].[tr_650_DatasetTemplates_010_default]'
 ...
 IF object_id('tempdb..#650_DatasetTemplates_010_default') IS NOT NULL
  DROP TABLE # 650_datasettemplates_010_default;
   ...
   SET @duration = datediff(ss, @startdatetime, @enddatetime) PRINT 'Load "load_650_DatasetTemplates_010_default" took ' + cast(@duration AS varchar(10)) + ' second(s)'
