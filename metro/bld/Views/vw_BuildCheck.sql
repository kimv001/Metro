        ...
        */
        WITH Cur AS (
            SELECT 
                [BuildCheckId] AS [BuildCheckId], [BK] AS [BK], [Code] AS [Code], [CheckMessage] AS [CheckMessage], [LayerName] AS [LayerName], [SchemaName] AS [SchemaName], [GroupName] AS [GroupName], [ShortName] AS [ShortName],
