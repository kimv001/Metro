        ...
        */
        WITH Cur AS (
            SELECT 
                [DWHRefTemplatesId] AS [DWHRefTemplatesId], [BK] AS [BK], [Code] AS [Code], [BK_Template] AS [BK_Template], [BK_Dataset] AS [BK_Dataset], [TemplateType] AS [TemplateType], [TemplateSource] AS [TemplateSource], [BK_RefType_ObjectType] AS [BK_RefType_ObjectType], [TemplateScript] AS [TemplateScript], [TemplateVersion] AS [TemplateVersion], [RowNum] AS [RowNum],
