        ...
        */
        WITH Cur AS (
            SELECT 
                [MarkersSmartLoadId] AS [MarkersSmartLoadId], [BK] AS [BK], [Code] AS [Code], [SrcCreateDate] AS [SrcCreateDate], [TgtCreateDate] AS [TgtCreateDate], [IsUpdated] AS [IsUpdated], [RecType] AS [RecType],
